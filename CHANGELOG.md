...
- resolved cookstyle error: examples/automate_win/metadata.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/automate_win/recipes/chef_client_config.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/automate_win/recipes/default.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/automate_win/spec/spec_helper.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/automate_win/spec/unit/recipes/chef_client_config_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/automate_win/spec/unit/recipes/default_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/chef-server/Vagrantfile:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/wrapper_audit/Berksfile:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/wrapper_audit/metadata.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/wrapper_audit/recipes/default.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/wrapper_audit/spec/spec_helper.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: examples/wrapper_audit/spec/unit/recipes/default_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: libraries/helper.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: libraries/helper.rb:115:10 convention: `Style/ExpandPathArguments`
- resolved cookstyle error: libraries/helper.rb:119:10 convention: `Style/ExpandPathArguments`
- resolved cookstyle error: libraries/reporters/audit-enforcer.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: libraries/reporters/automate.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: libraries/reporters/automate.rb:108:7 convention: `Style/ReturnNil`
- resolved cookstyle error: libraries/reporters/cs_automate.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: libraries/reporters/json_file.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: metadata.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: recipes/default.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: recipes/inspec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/data/mock_profile.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/spec_helper.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/unit/libraries/automate_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/unit/libraries/automate_spec.rb:23:18 convention: `Style/RedundantFileExtensionInRequire`
- resolved cookstyle error: spec/unit/libraries/cs_automate_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/unit/libraries/cs_automate_spec.rb:9:18 convention: `Style/RedundantFileExtensionInRequire`
- resolved cookstyle error: spec/unit/libraries/helpers_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/unit/libraries/helpers_spec.rb:9:18 convention: `Style/RedundantFileExtensionInRequire`
- resolved cookstyle error: spec/unit/libraries/json_file_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/unit/recipes/default_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/unit/report/audit_report_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: spec/unit/report/audit_report_spec.rb:24:18 convention: `Style/RedundantFileExtensionInRequire`
- resolved cookstyle error: spec/unit/report/audit_report_spec.rb:153:19 convention: `Style/ExpandPathArguments`
- resolved cookstyle error: spec/unit/report/audit_report_spec.rb:165:19 convention: `Style/ExpandPathArguments`
- resolved cookstyle error: spec/unit/report/audit_report_spec.rb:190:19 convention: `Style/ExpandPathArguments`
- resolved cookstyle error: spec/unit/report/fetcher_spec.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: test/integration/default/default.rb:1:1 convention: `Style/Encoding`
- resolved cookstyle error: test/integration/default/default.rb:6:3 convention: `Style/StderrPuts`
- resolved cookstyle error: test/kitchen-automate/Berksfile:1:1 convention: `Style/Encoding`
- resolved cookstyle error: test/kitchen-automate/libraries/helper.rb:1:1 convention: `Style/Encoding`
