...
describe 'Collector::ChefVisibility methods' do
  before :each do
    ...
    @blob={:node=>"chef-client.solo",
          :os=>{:release=>"10.11.5", :family=>"mac_os_x"},
  ...
  it 'counts controls like an accountant' do
    ...
    expected_count = {"total"=>5, "successful"=>1, "skipped"=>1, "failed"=>3, "minor"=>1, "major"=>1, "critical"=>1}
